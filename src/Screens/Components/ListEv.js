...
const ListEv = ({ dataEv, loading, onRefresh }) => {
    ...
    <View style={styles.container}>
      {loading ? (
        ...
        <FlatList
          ...
          initialNumToRender={10} // Số lượng phần tử ban đầu cần render
          // windowSize={5} // Số lượng màn hình cần giữ trong bộ nhớ đệm
          maxToRenderPerBatch={5} // Số lượng phần tử tối đa được render mỗi lần
          refreshControl={
            <RefreshControl
              refreshing={loading}
              onRefresh={onRefresh}
